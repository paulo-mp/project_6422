...
homicides_choropleth <- 
  animate(
    ggplot(joined_spatial_data) + # using joined spatial dataset
      ...
      theme(
        plot.title = element_text(size = 15, family = "Helvetica", face = "bold", hjust = 0.5),
        plot.subtitle = element_text(size = 11, family = "Helvetica", hjust = 0.5),
        plot.caption = element_text(face = "italic", hjust = 1),
        plot.margin = margin(t = 30, r = 10, b = 10, l = 10)
      ), # adjusting formatting of text in visualisatiojn
...
# saving data used in final visualisation
